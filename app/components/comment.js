  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.fId, this.state.index, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.fId, this.state.index, 4, callbackFunction);
      }
    }
  }
      ...
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}>
                {likeButtonText} ({data.likeCounter.length})
              </a> · <a href="#">Reply</a> ·
